...
# Load weights for the first 6 layers
model.load_weights('image_captioning_transformer_weights.h5', by_name=True, skip_mismatch=True)
...
def main():
    ...
    encoder = TransformerEncoderLayer(EMBEDDING_DIM, 1)
    decoder = TransformerDecoderLayer(EMBEDDING_DIM, UNITS, 8)
    cnn_model = CNN_Encoder()  # Specify the decoder model
    image_captioning_model = ImageCaptioningModel(cnn_model, encoder, decoder)
    ...
    if uploaded_file is not None:
        ...
        captions = generate_captions(image, model, transform)
...
def generate_captions(image, model, transform):
